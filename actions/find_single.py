...
class FindSingle(Action):
    ...
    def action(self):
        try:
            ...
            rpo_error_count, rpo_points_count, rpo_time_elapsed = rpo_repository.find_point_by_coordinates(x, y)
            s_error_count, s_points_count, s_time_elapsed = sp_repository.find_point_by_coordinates(x, y)
