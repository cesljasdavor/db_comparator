...
class FindMultipleRotatedRectangle(Action):
    def __init__(self, window):
        ...
        self.rename_window("Database Comparator - Find Multiple - Rotated Rectangle")
    ...
    def action(self):
        ...
        relational_data = rp_repository.find_points_in_rotated_rectangle(
            bottom_left_corner,
            width,
            height,
            angle
        ...
        spatial_core_data = scp_repository.find_points_in_rotated_rectangle(
            bottom_left_corner,
            width,
            height,
            angle
        ...
        spatial_postgis_data = spp_repository.find_points_in_rotated_rectangle(
            bottom_left_corner,
            width,
            height,
            angle
