...
class UpdateSingle(Action):
    ...
    def action(self):
        try:
            ...
            r_has_errors, r_points_count, r_time_elapsed = rp_repository.update_point_by_coordinates(x, y, step)
            sc_has_errors, sc_points_count, sc_time_elapsed = scp_repository.update_point_by_coordinates(x, y, step)
            sp_has_errors, sp_points_count, sp_time_elapsed = spp_repository.update_point_by_coordinates(x, y, step)
