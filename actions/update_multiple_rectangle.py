...
class UpdateMultipleRectangle(Action):
    ...
    def init_gui(self):
        action_title = Label(self.window, text="Update Multiple - Rectangle", anchor=CENTER, font=('Courier', 20),
                             bg="#313335", fg="#ffffff")
    ...
    def action(self):
        ...
        r_error_count, r_points_count, r_time_elapsed = rp_repository.update_points_in_rectangle(
            bottom_left_corner,
            width,
            height,
            step
        ...
        sc_error_count, sc_points_count, sc_time_elapsed = scp_repository.update_points_in_rectangle(
            bottom_left_corner,
            width,
            height,
            step
        ...
        sp_error_count, sp_points_count, sp_time_elapsed = spp_repository.update_points_in_rectangle(
            bottom_left_corner,
            width,
            height,
            step
