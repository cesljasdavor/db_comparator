...
class UpdateMultipleRectangle(Action):
    ...
    def action(self):
        ...
        r_has_errors, r_points_count, r_time_elapsed = rp_repository.update_points_in_rectangle(
            bottom_left_corner,
            width,
            height,
            step
        ...
        sc_has_errors, sc_points_count, sc_time_elapsed = scp_repository.update_points_in_rectangle(
            bottom_left_corner,
            width,
            height,
            step
        ...
        sp_has_errors, sp_points_count, sp_time_elapsed = spp_repository.update_points_in_rectangle(
            bottom_left_corner,
            width,
            height,
            step
