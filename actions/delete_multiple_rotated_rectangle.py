...
class DeleteMultipleRotatedRectangle(Action):
    ...
    def __init__(self, window):
        ...
        self.rename_window("Database Comparator - Delete Multiple - Rotated Rectangle")
    ...
    def action(self):
        ...
        relationa_data = rp_repository.delete_points_in_rotated_rectangle(
            bottom_left_corner,
            width,
            height,
            angle
        ...
        spatial_core_data = scp_repository.delete_points_in_rotated_rectangle(
            bottom_left_corner,
            width,
            height,
            angle
        ...
        spatial_postgis_data = spp_repository.delete_points_in_rotated_rectangle(
            bottom_left_corner,
            width,
            height,
            angle
        ...
        self.show_statistics(relationa_data, spatial_core_data, spatial_postgis_data)
