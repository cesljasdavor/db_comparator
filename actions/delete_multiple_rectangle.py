...
class DeleteMultipleRectangle(Action):
    ...
    def __init__(self, window):
        ...
        self.rename_window("Database Comparator - Delete Multiple - Rectangle")
    ...
    def action(self):
        ...
        relational_data = rp_repository.delete_points_in_rectangle(
            bottom_left_corner,
            width,
            height
        )
        ...
        spatial_core_data = scp_repository.delete_points_in_rectangle(
            bottom_left_corner,
            width,
            height
        )
        ...
        spatial_postgis_data = spp_repository.delete_points_in_rectangle(
            bottom_left_corner,
            width,
            height
        )
