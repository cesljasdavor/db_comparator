...
class DeleteMultipleCircle(Action):
    ...
    def action(self):
        ...
        r_error_count, r_points_count, r_time_elapsed = rp_repository.delete_points_in_circle(center, radius)
        ...
        rpo_error_count, rpo_points_count, rpo_time_elapsed = rpo_repository.delete_points_in_circle(center, radius)
        ...
        s_error_count, s_points_count, s_time_elapsed = sp_repository.delete_points_in_circle(center, radius)
