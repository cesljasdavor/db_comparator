...
class FindMultipleCircle(Action):
    def __init__(self, window):
        ...
        self.rename_window("Database Comparator - Find Multiple - Circle")
    ...
    def action(self):
        ...
        relational_data = rp_repository.find_points_in_circle(center, radius)
        ...
        spatial_core_data = scp_repository.find_points_in_circle(center, radius)
        ...
        spatial_postgis_data = spp_repository.find_points_in_circle(center, radius)
