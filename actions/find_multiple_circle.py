...
class FindMultipleCircle(Action):
    ...
    def action(self):
        ...
        sc_error_count, sc_points_count, sc_time_elapsed = scp_repository.find_points_in_circle(center, radius)
        ...
        sp_error_count, sp_points_count, sp_time_elapsed = spp_repository.find_points_in_circle(center, radius)
