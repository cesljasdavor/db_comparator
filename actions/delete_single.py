...
class DeleteSingle(Action):
    ...
    def init_gui(self):
        action_title = Label(self.window, text="Delete Single", anchor=CENTER, font=('Courier', 20), bg="#313335",
                             fg="#ffffff")
    ...
    def action(self):
        try:
            ...
            r_has_errors, r_points_count, r_time_elapsed = rp_repository.delete_point_by_coordinates(x, y)
            sc_has_errors, sc_points_count, sc_time_elapsed = scp_repository.delete_point_by_coordinates(x, y)
            sp_has_errors, sp_points_count, sp_time_elapsed = spp_repository.delete_point_by_coordinates(x, y)
