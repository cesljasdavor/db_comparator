...
class DeleteSingle(Action):
    ...
    def action(self):
        try:
            ...
            sc_error_count, sc_points_count, sc_time_elapsed = scp_repository.delete_point_by_coordinates(x, y)
            sp_error_count, sp_points_count, sp_time_elapsed = spp_repository.delete_point_by_coordinates(x, y)
