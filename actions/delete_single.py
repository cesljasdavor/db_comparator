...
class DeleteSingle(Action):
    ...
    def __init__(self, window):
        ...
        self.rename_window("Database Comparator - Delete Single")
    ...
    def action(self):
        ...
        relational_data = rp_repository.delete_point_by_coordinates(x, y)
        spatial_core_data = scp_repository.delete_point_by_coordinates(x, y)
        spatial_postgis_data = spp_repository.delete_point_by_coordinates(x, y)
