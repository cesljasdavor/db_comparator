...
class InsertSingle(Action):
    ...
    def __init__(self, window):
        ...
        self.rename_window("Database Comparator - Insert Single")
    ...
    def action(self):
        ...
        relational_data = rp_repository.insert_point(x, y)
        spatial_core_data = scp_repository.insert_point(x, y)
        spatial_postgis_data = spp_repository.insert_point(x, y)
