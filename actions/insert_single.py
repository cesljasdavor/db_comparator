...
class InsertSingle(Action):
    ...
    def init_gui(self):
        action_title = Label(self.window, text="Insert Single", anchor=CENTER, font=('Courier', 20), bg="#313335",
                             fg="#ffffff")
    ...
    def action(self):
        try:
            ...
            r_error_count, r_points_count, r_time_elapsed = rp_repository.insert_point(x, y)
            sc_error_count, sc_points_count, sc_time_elapsed = scp_repository.insert_point(x, y)
            sp_error_count, sp_points_count, sp_time_elapsed = spp_repository.insert_point(x, y)
