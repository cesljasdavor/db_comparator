...
class InsertSingle(Action):
    ...
    def action(self):
        try:
            ...
            rpo_error_count, rpo_points_count, rpo_time_elapsed = rpo_repository.insert_point(x, y)
            s_error_count, s_points_count, s_time_elapsed = sp_repository.insert_point(x, y)
